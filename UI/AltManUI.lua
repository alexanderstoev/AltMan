...
function AltMan.UI:DrawInfo(data)
    ...
    AltMan.frame.maininfo:SetPoint("TOPLEFT", AltMan.constants.presentation.frame.paddingHorizontal,
...
function AltMan.UI:InitAltSection()
    ...
    AltMan.frame.altsSection:SetPoint("TOPLEFT", AltMan.constants.presentation.frame.paddingHorizontal,
        -AltMan.frame:GetHeight());
    AltMan.frame.altsSection:SetWidth(
        AltMan.UI:GetFrameWidth() - AltMan.constants.presentation.frame.paddingHorizontal * 2);
end
...
function AltMan.UI:DrawAltsInfo()
    ...
    AltMan.frame.altsinfo:SetPoint("TOPLEFT", AltMan.constants.presentation.frame.paddingHorizontal,
        -AltMan.frame:GetHeight());
...
function AltMan.UI:DrawDailyActivities()
    ...
    AltMan.frame.altsinfo.daily:SetWidth(AltMan.UI:GetFrameWidth() -
                                             AltMan.constants.presentation.frame.paddingHorizontal * 2);
...
function AltMan.UI:DrawWeeklyActivities()
    ...
    AltMan.frame.altsinfo.weekly:SetWidth(AltMan.UI:GetFrameWidth() -
                                              AltMan.constants.presentation.frame.paddingHorizontal * 2);
