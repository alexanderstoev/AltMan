...
function AltMan.UI:DrawInfo(data)
    ...
    AltMan.frame.maininfo:SetPoint("TOPLEFT", AltMan.constants.presentation
                                       .frame.paddingHorizontal,
                                   -AltMan.frame:GetHeight());

    AltMan.frame.maininfo:SetWidth(AltMan.UI:GetFrameWidth() -
    ...
    for k, v in pairs(data) do
        ...
        AltMan.UI:CreateNewString(k, AltMan.frame.maininfo, 0, -index *
                                      AltMan.constants.presentation.lineheight);
        index = index + 1
    end
...
function AltMan.UI:PrintMainInfo(data)
    for k, v in pairs(data) do AltMan.frame.maininfo[k]:SetText(v); end
end
...
function AltMan.UI:InitAltSection()
    ...
    AltMan.frame.altsSection:SetPoint("TOPLEFT", AltMan.constants.presentation
                                          .frame.paddingHorizontal,
                                      -AltMan.frame:GetHeight());
    AltMan.frame.altsSection:SetWidth(AltMan.UI:GetFrameWidth() -
                                          AltMan.constants.presentation.frame
                                              .paddingHorizontal * 2);
end

function AltMan.UI:DrawAltInfo(type, data) end
...
function AltMan.UI:DrawAltsInfo()
    ...
    AltMan.frame.altsinfo:SetPoint("TOPLEFT", AltMan.constants.presentation
                                       .frame.paddingHorizontal,
                                   -AltMan.frame:GetHeight());
    AltMan.frame.altsinfo:SetWidth(AltMan.UI:GetFrameWidth() -
                                       AltMan.constants.presentation.frame
                                           .paddingHorizontal * 2);

    AltMan.UI:DrawAltCoreData();
    AltMan.UI:IncreaseFrameHeight(AltMan.frame.altsinfo, AltMan.constants
                                      .presentation.frame.paddingVertical);
...
function AltMan.UI:DrawAltCoreData()
    ...
    AltMan.frame.altsinfo.core:SetPoint("TOPLEFT", 0,
                                        -AltMan.frame.altsinfo:GetHeight());
    AltMan.frame.altsinfo.core:SetWidth(AltMan.UI:GetFrameWidth() -
                                            AltMan.constants.presentation.frame
                                                .paddingHorizontal * 2);

    local newFrameHeight = 0
    AltMan.UI:CreateNewString("daiilylabel", AltMan.frame.altsinfo.core, 0, 0,
                              true);
...
function AltMan.UI:DrawColumn(dataObjs) end

function AltMan.UI:DrawDailyActivities()
    AltMan.frame.altsinfo.daily =
        CreateFrame("frame", "", AltMan.frame.altsinfo);
    AltMan.frame.altsinfo.daily:SetFrameStrata("MEDIUM");
    AltMan.frame.altsinfo.daily:SetPoint("TOPLEFT", 0,
                                         -AltMan.frame.altsinfo:GetHeight());
    AltMan.frame.altsinfo.daily:SetWidth(
        AltMan.UI:GetFrameWidth() -
            AltMan.constants.presentation.frame.paddingHorizontal * 2);

    local newFrameHeight = 0
    AltMan.UI:CreateNewString("daiilylabel", AltMan.frame.altsinfo.daily, 0, 0,
                              true);
...
function AltMan.UI:DrawWeeklyActivities()
    AltMan.frame.altsinfo.weekly = CreateFrame("frame", "",
                                               AltMan.frame.altsinfo);
    AltMan.frame.altsinfo.weekly:SetFrameStrata("MEDIUM");
    AltMan.frame.altsinfo.weekly:SetPoint("TOPLEFT", 0,
                                          -AltMan.frame.altsinfo:GetHeight());
    AltMan.frame.altsinfo.weekly:SetWidth(
        AltMan.UI:GetFrameWidth() -
            AltMan.constants.presentation.frame.paddingHorizontal * 2);

    local newFrameHeight = 0;
    AltMan.UI:CreateNewString("weeklylabel", AltMan.frame.altsinfo.weekly, 0, 0,
                              true);
...
function AltMan.UI:addLine(source, index)
    ...
    -- create the string frame
    AltMan.UI:CreateNewString(source, AltMan.frame.maininfo, 0,
